...
$(EXEC): clean 
	...
	@$(CC) $(CFLAGS) $(LDFLAGS) main.cc view/camera/camera.cc view/interface/inputmanager.cc view/interface/interface.cc view/drawer/Shader.cpp view/drawer/gpu.cc -o $(EXEC) 
